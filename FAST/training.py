...
class FASTTrainer:
    ...
    def prepare_data(self, 
                    ...
                    max_length: int = 40) -> Tuple[DataLoader, DataLoader]:
        """
    ...
    def evaluate_mse(self, 
        ...
        with torch.no_grad():
            predicted_tokens = self.model.generate(
                ...
                max_length=45,  # Match the max_length used in training
...
def run_experiment(sampling_rates: List[int] = None,
    ...
    for H in sampling_rates:
        ...
        model = SimpleTransformer(
            vocab_size=1024,  # FAST tokenizer vocabulary size
            d_model=128,
            nhead=8,
            num_layers=4,
            max_seq_len=50,  # Fixed max sequence length for padding
            conditioning_dim=8
        )
