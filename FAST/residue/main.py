...
def main():
    ...
    if not args.skip_training:
        print("=" * 60)
        print("TOY PROBLEM CASE STUDY: FAST TOKENIZATION")
        print("=" * 60)
        print("This experiment reproduces the case study from the paper")
        print("showing how FAST tokenization improves performance at high sampling rates.")
        print("=" * 60)
    ...
    print("\nThis demonstrates the effectiveness of the DCT-based FAST tokenization")
    print("proposed in the paper, which maintains better performance at high sampling rates.")
