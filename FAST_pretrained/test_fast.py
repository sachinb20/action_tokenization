...
def generate_and_fit_dataset():
    ...
    # Initialize FAST tokenizer (loads pretrained weights automatically in constructor)
    print("\nInitializing pretrained FAST tokenizer...")
    fast_tokenizer = FASTTokenizer()
    
    print("Pretrained FAST tokenizer ready!")
    ...
    padded_tokens = fast_tokenizer.tokenize_with_padding(test_data, pad_token=0, max_length=40)
